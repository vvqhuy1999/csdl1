...
alter table BenhAn
add column LoaiBenh nvarchar(50);
...
VALUES 
  ...
  INSERT INTO Kham (MaBS, MaBenhAn)
VALUES 
  ('BS01', 'BA01'), 
  ('BS02', 'BA02'), 
  ('BS03', 'BA03'),
...
INSERT INTO HoaDon (MaHD, TenHD, TongTien, MaBN)
VALUES 
  ('HD01', 'Hóa đơn 01', 5000000, 'BN01'), 
  ('HD02', 'Hóa đơn 02', 3000000, 'BN02'), 
  ('HD03', 'Hóa đơn 03', 7000000, 'BN03'),
  ('HD04', 'Hóa đơn 04', 2000000, 'BN04'),
  ('HD05', 'Hóa đơn 05', 1000000, 'BN05'),
	('HD06', 'Hóa đơn 06', 2500000, 'BN06'), 
  ('HD07', 'Hóa đơn 07', 3500000, 'BN07'), 
  ('HD08', 'Hóa đơn 08', 4500000, 'BN08'),
  ('HD09', 'Hóa đơn 09', 5500000, 'BN09'),
  ('HD10', 'Hóa đơn 10', 6500000, 'BN10');
